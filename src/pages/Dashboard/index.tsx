...
import cryImg from "../../assets/cry.svg";
import ops from "../../assets/ops.svg";
import GraphicPieChart from "../../components/PieChartBox";
...
const Dashboard: React.FC = () => {
  ...
  const years = useMemo(() => {
    ...
    [...expenses, ...gains].forEach((item: any) => {
  ...
  const relationExpensevesRecurrentVersusEventual = useMemo(() => {
    ...
    const percentCurrent = Number(((amountEventual / total) * 100).toFixed(1));
  ...
  return (
    <Container>
      ...
      <Content>
        ...
        <GraphicPieChart data={relationExpensesVersusGains} />
